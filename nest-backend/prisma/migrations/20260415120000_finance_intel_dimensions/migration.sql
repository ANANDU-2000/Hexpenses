...
-- CreateIndex
CREATE UNIQUE INDEX "ExpenseTypeDef_subCategoryId_nameKey_key" ON "ExpenseTypeDef"("subCategoryId", "nameKey");

-- CreateIndex
CREATE INDEX "ExpenseTypeDef_userId_idx" ON "ExpenseTypeDef"("userId");

-- CreateIndex
CREATE INDEX "ExpenseTypeDef_subCategoryId_sortOrder_idx" ON "ExpenseTypeDef"("subCategoryId", "sortOrder");

-- CreateIndex
CREATE UNIQUE INDEX "SpendEntity_vehicleId_key" ON "SpendEntity"("vehicleId");

-- CreateIndex
CREATE UNIQUE INDEX "SpendEntity_subCategoryId_nameKey_key" ON "SpendEntity"("subCategoryId", "nameKey");

-- CreateIndex
CREATE INDEX "SpendEntity_userId_categoryId_idx" ON "SpendEntity"("userId", "categoryId");

-- CreateIndex
CREATE INDEX "SpendEntity_workspaceId_idx" ON "SpendEntity"("workspaceId");
...
-- CreateIndex
CREATE INDEX "Expense_userId_subCategoryId_date_idx" ON "Expense"("userId", "subCategoryId", "date");

-- CreateIndex
CREATE INDEX "Expense_userId_expenseTypeId_date_idx" ON "Expense"("userId", "expenseTypeId", "date");

-- CreateIndex
CREATE INDEX "Expense_userId_spendEntityId_date_idx" ON "Expense"("userId", "spendEntityId", "date");
