...
final expensesProvider = StreamProvider.autoDispose<List<Map<String, dynamic>>>((ref) {
...
final expensesForAccountProvider =
    Provider.autoDispose.family<AsyncValue<List<Map<String, dynamic>>>, String>((ref, accountId) {
